...
다만 CP033371.1은 ANI 분석에서는 정상 범주에 속했으나, accessory genome 기반 계통수에서는 **비정상적으로 긴 branch**를 형성하였으나, 그 원인을 찾지는 못하였다.

---

### 5.3 발효 산업 적용

CP076082.1와 같이 특정 환경에서 어떤 strain이 잘 살아남고, 발효를 잘 시킬 수 있는 지 안다면, 발효 최적화 균주 스타터로 선별해 사용할 수 있는 기대점이 있다.
